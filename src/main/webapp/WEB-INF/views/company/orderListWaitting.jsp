                        ...
                        <div class="row">
					         <div class="col-lg-6">               
					                   <ul class="nav nav-tabs" id="myTab" role="tablist">
					                       <li class="nav-item">
					                           <a class="nav-link  active"  style = "background : #F7F7F7" href="movePage.com?movePage=orderListWaitting">대기중</a>
					                       </li>
					                       <li class="nav-item">
                                ...
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered" style = "table-layout : fixed; word-wrap : break-word;">
                                    ...
                                    <tbody>
                                        <tr class = "adminMessageTr" style = "cursor : pointer;">
                                            ...
                                            <td> <button type="button" class="btn btn-primary btn-sm">수락</button>
                                        	<button type="button" class="btn btn-secondary btn-sm">거절</button></td>
                                        </tr>
                                        <tr class = "adminMessageTr" style = "cursor : pointer;">
                                            <td>2</td>
                                            <td>tjnwn123</td>
