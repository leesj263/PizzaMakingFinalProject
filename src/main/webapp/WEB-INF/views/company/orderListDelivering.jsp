					...
					<div class="col-md-12">
						<div class="card">
								...
								<div class="col-lg-6">
									<ul class="nav nav-tabs" id="myTab" role="tablist">
										...
										<li class="nav-item"><a class="nav-link active"
											style="background: #F7F7F7" href="orderDelivering.com?comNo=${sessionScope.loginUser.comNo }">배달중</a>
										</li>
										<li class="nav-item"><a class="nav-link "
							...
							<div class="card-header">
								<strong class="card-title">배달중 목록</strong>
							</div>
							<div class="card-body">
									...
									<tbody>
										...
										<c:forEach items="${list}" var="value">
											<tr class="adminMessageTr" style="cursor: pointer;">
												...
												<td>
													<button type="button" class="btn btn-primary btn-sm" onclick = "location.href = 'deliveryComplete.com?orderNo=${ value.orderNo }&comNo=${sessionScope.loginUser.comNo }'">배달완료</button>
												</td>
											</tr>
										</c:forEach>
