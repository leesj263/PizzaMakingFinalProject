							...
							<div class="row">
								<div class="col-lg-6">
									<ul class="nav nav-tabs" id="myTab" role="tablist">
										...
										style="background: #F7F7F7" href="orderRefuseList.com">거절목록</a></li>
									</ul>
								</div>
							</div>
							<!-- 화면 전환 탭  끝-->
									...
									<tbody>
										<c:forEach items="${list}" var="value">
											<tr class="adminMessageTr" style="cursor: pointer;">
												...
												<td>
													<button type="button" class="btn btn-danger btn-sm" onclick = "location.href = 'refuseListDelete.com?orderNo=${ value.orderNo }'">삭제</button>
												</td>
											</tr>
										</c:forEach>
