...
<body>
    ...
    <!-- scripit init-->
    <script src="${contextPath }/resources/companyCss/assets/js/init-scripts/peitychart/peitychart.init.js"></script>
    <!-- scripit init-->
    <script src="${contextPath }/resources/companyCss/vendors/peity/jquery.peity.min.js"></script>
    <!-- scripit init-->
    <script src="${contextPath }/resources/companyCss/assets/js/init-scripts/peitychart/peitychart.init.js"></script>
    <!-- scripit init-->
