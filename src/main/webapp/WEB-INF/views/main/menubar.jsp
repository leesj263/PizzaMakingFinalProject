...
<body>
		...
		<div class="mar">
			<form action="insertJoin.co" method="post">
				<table class="table">
						...
						<td>
							<div class="inline field">
								<div class="ui toggle checkbox">
									<input type="checkbox" tabindex="0" class="hidden"> <label>사업자로
										변환하기</label> <input type="hidden" name="changeNum" id="changeNum"
										value="1">
								</div>
							</div>
						</td>
					...
					<tr>
						<td colspan="2"><div class="ui input" style="width: 100%">
								<input type="text" placeholder="닉네임을 입력하세요" id="memberNickName"
									name="memberNickName">
							</div></td>
					</tr>
					<tr>
						...
						<td align="center">
							<button class="ui yellow basic button" style="width: 100%"
								onclick="return IdCheckBtn()">아이디 중복확인</button>
						</td>
					</tr>
					<tr>
						<td colspan="2"><div class="ui input" style="width: 100%">
								<input type="password" placeholder="비밀번호" id="memberPwd"
									name="memberPwd">
							</div></td>
					</tr>
					<tr>
					...
					<tr>
						<td><div class="ui input" style="width: 100%">
								<input type="text" placeholder="이메일" id="memberEmail"
									name="memberEmail">
							</div></td>
						<td align="center">
							<button class="ui yellow basic button" style="width: 100%"
								onclick="return CertificationSendBtn()">인증번호 발송</button>
						</td>
					</tr>
					<tr>
						<td><div class="ui input" style="width: 100%">
								<input type="text" placeholder="인증번호를 확인해주세요"
									id="JoinCertificationNum">
							</div></td>
						<td align="center">
							<button class="ui yellow basic button" style="width: 100%"
								id="Certification" onclick="return CertificationBtn()">인증
								확인</button>
						</td>
					</tr>
					...
					<tr style="display: none;" id="comNameTr">
						<td colspan="2"><div class="ui input" style="width: 100%">
								<input type="text" placeholder="지점명을 입력하세요" id="comName"
									name="comName">
							</div></td>
					</tr>
					<tr style="display: none;" id="comAddressTr">
						<td><div class="ui input" style="width: 100%">
								<input type="text" placeholder="우편 번호 (검색 이용)" id="comAddress"
									name="comAddress" readonly>
							</div></td>
						<td align="center">
							<div class="ui yellow basic button" style="width: 100%"
								onclick="return postNumSearch()">우편번호 검색</div>
						</td>
					</tr>
					<tr style="display: none;" id="comAddressTr3">
						<td colspan="2"><div class="ui input" style="width: 100%">
								<input type="text" placeholder="주소 " id="comAddress3"
									name="comAddress3" readonly>
							</div></td>
					</tr>

					<tr style="display: none;" id="comAddressTr2">
						<td><div class="ui input" style="width: 100%">
								<input type="text" placeholder="상세주소 입력" id="comAddress2"
									name="comAddress2">
							</div></td>
						<td><div class="ui input" style="width: 100%">
								<input type="text" placeholder="참고주소(입력X)" id="comAddress4"
									name="comAddress4" readonly>
							</div></td>
					</tr>

					<tr style="display: none;" id="comTelTr">
						<td colspan="2"><div class="ui input" style="width: 100%">
								<input type="tel" placeholder="매장 전화번호 (EX:02-1234-1234)"
									id="comTel" name="comTel">
							</div></td>
					</tr>
					<tr style="display: none;" id="comLisensenoTr">
						<td colspan="2"><div class="ui input" style="width: 100%">
								<input type="text" placeholder="사업자 번호" id="comLisenseno"
									name="comLisenseno">
							</div></td>
					</tr>
					...
					<tr style="display: none;" id="comLocationTr">
						<td colspan="2"><div class="ui input" style="width: 100%">
								<input type="text" placeholder="매장 상세 위치정보 (EX : 역삼역 4번출구 방향)"
									id="comLocation" name="comLocation">
							</div></td>
					</tr>
					<tr style="display: none;" id="comParkingTr">
						<td colspan="2"><div class="ui input" style="width: 100%">
								<input type="text" placeholder="주차정보 (EX : 약 10대 주차가능 or 주차불가능)"
									id="comParking" name="comParking">
							</div></td>
					</tr>
					...
					<tr>
					 ...
					 -->
						...
						<TD align="center">
							<button class="ui yellow button" onclick="return AllcloseBtn()"
			...
			<c:if test="${memberId !=null}">
				...
				<!-- 	<tr>
					...
					<tr>
						...
						<td align="center">
							<button class="ui yellow basic button" style="width: 100%"
								onclick="return kakaoCertificationSendBtn()">인증번호 발송</button>
						</td>
					</tr>
					<tr>
						<td><div class="ui input" style="width: 100%">
								<input type="text" placeholder="인증번호를 확인해주세요"
									id="kakaoJoinCertificationNum">
							</div></td>
						<td align="center">
							<button class="ui yellow basic button" style="width: 100%"
								id="kakaoCertification" onclick="return kakaoCertificationBtn()">인증
								확인</button>
						</td>
					</tr>
	...
	<form action="login.co" method="post" id="loginFormId">
			...
			<h1>LOGIN</h1>
					...
					<tr>
						...
						<td rowspan="2">
							<button class="ui yellow basic button"
								style="width: 100%; height: 78px" id="loginBtn"
								onclick="return memberLoginBtn()">로그인</button>
				...
				<script type='text/javascript'>
									...
									Kakao
											.init('193ce7b860db2d5f477856840d1b7fb4');
									// 카카오 로그인 버튼을 생성합니다.
					...
					<tr>
						...
						<div class="ui form">
							...
							<table class="table">
								<tr>
									<td colspan="2"><div class="ui left icon input">
											<input type="text" placeholder="이름" id="noMemberName"
												name="memberName" style="width: 350px"> <i
								...
								<tr>
									<td><div class="ui left icon input">
											<input type="text" placeholder="핸드폰 번호 입력하세요"
												id="noMemberPhone" name="memberPhone"> <i
												class="heart outline icon"></i>
										</div></td>
									<td>
										<div class="ui yellow basic button"
											style="width: 100%; height: 40px" id="phoneCertificationSend"
											onclick="return phoneCertificationSend()">인증번호 발송</div>
								...
								<tr>
									<td><div class="ui left icon input">
											<input type="text" placeholder="인증번호"
												name="memberCertificationNumber"
												id="memberCertificationNumber"> <i
												class="envelope outline icon"></i>
										</div></td>

									<td>
										<div class="ui yellow basic button"
											style="width: 100%; height: 40px" id="nonMemberCertification"
											onclick="return CertificationCheckBtn()">인증번호 확인</div>
								...
								<tr>
									<td colspan="3">
										<button class="ui yellow button"
											style="width: 300px; height: 60px; margin-left: 20px"
											type="submit" id="NonMemberloginBtn">비회원로그인</button>
		...
		<div id="idPwdSearchDiv" class="hiddenCss">
			...
			<div class="mar">
				<table class="table">
					...
					<tr>
						<td colspan="2"><div class="ui input" style="width: 100%">
								<input type="text" placeholder="이름 입력" id="idSearchName"
									name="memberName">
							</div></td>
					</tr>
					<tr>
						<td><div class="ui input">
								<input type="text" placeholder="이메일" id="idSearchEmail"
									name="memberEmail">
							</div></td>
						<td align="center">
							<div class="ui yellow basic button" style="width: 100%"
								onclick="return idSendBtn();">아이디 전송</div>
						</td>
					</tr>
					<tr>
						<td>&nbsp;</td>
					...
					<tr>
						<td colspan="2"><div class="ui input" style="width: 100%">
								<input type="text" placeholder="아이디를 입력하세요" id="pwdSearchId"
									name="memberId">
							</div></td>
					</tr>
					<tr>
						<td><div class="ui input">
								<input type="text" placeholder="이메일을 입력하세요" id="pwdSearchEmail"
									name="memberEmail">
							</div></td>
						<td align="center">
							<div class="ui yellow basic button" style="width: 100%"
								onclick="return PwdSendBtn()">임시 비밀번호</div>
						</td>
					</tr>
					<tr>
						<td>&nbsp;</td>
	...
	<script>
		...
		var kakaojoindiv = document.all.kakaojoindiv;//카카오 회원가입

		function join() {
			joindiv.style.visibility = "visible";
			loginDiv.style = "hide";
			kakaojoindiv.style= "hide";
		...
		$(function () {
			console.log("ㅠㅠㅠ"+"${check}");
			if("${check}"!=null &&"${check}"=="check"){
				kakaojoindiv.style.visibility = "visible";
				loginDiv.style = "hide";
				joindiv.style = "hide";
		...
		//카카오 인증번호 발송
		function kakaoCertificationSendBtn(){
			CertificationSend = 2;
			
			var memberEmail = $("#kakaomemberEmail").val();
		...
		//회원가입-이메일 인증확인 버튼
		function kakaoCertificationBtn() {
			Certification = 2;
			if ($("#kakaoJoinCertificationNum").val() == chkRandomCode) {
				console.log("인증확인 되었습니당~!!");
				swal("인증 완료!");
			} else {
				swal("인증 번호 확인해주세요");
	...
	<script>
		...
		function CertificationCheckBtn() {
			var memberCertificationNumber = $("#memberCertificationNumber")
					.val();
